document.addEventListener("DOMContentLoaded",()=>{
  ...
  const makeWalletGallery=()=>{
    ...
    section.innerHTML=`<div class="wrap"><div class="site-gallery-heading"><div><p class="eyebrow">LEATHER GOODS</p><h2>The Ave</h2><p>Individually made, for an individual purpose.</p></div><button class="site-gallery-close" type="button">Close Gallery</button></div><div class="gallery-cover wallet-gallery-cover"><div class="gallery-cover-photo"><img src="photos/wallets/the-ave/IMG_3722.jpeg" alt="The Ave wallet"></div><h3 class="gallery-cover-title">The Ave</h3><p class="gallery-cover-note">Click to view all photos</p></div><div class="gallery-details"><button class="gallery-back" type="button">← Back to Cover</button><div class="site-gallery-main"><div class="site-gallery-main-photo"><img src="photos/wallets/the-ave/IMG_3722.jpeg" alt="The Ave wallet"></div><div class="site-gallery-thumbs"><button class="site-gallery-thumb" type="button"><img src="photos/wallets/the-ave/IMG_3722.jpeg" alt="The Ave wallet front view"></button><button class="site-gallery-thumb" type="button"><img src="photos/wallets/the-ave/IMG_3723.jpeg" alt="The Ave wallet detail view"></button></div></div></div></div>`;
