document.addEventListener("DOMContentLoaded",()=>{
  ...
  [wallet,wood].forEach(gallery=>{
    const main=gallery.querySelector(".site-gallery-main-photo img");
    gallery.querySelectorAll(".site-gallery-thumb").forEach(button=>button.addEventListener("click",()=>{
      const image=button.querySelector("img");
      main.src=image.src;main.alt=image.alt;
    }));
    gallery.querySelector(".site-gallery-close")?.addEventListener("click",()=>gallery.classList.remove("is-open"));
  });
});
